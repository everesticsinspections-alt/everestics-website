...
const team = [
  {
    ...
    experience: "18 years",
    speciality: "Structural & Compliance",
  },
  {
    name: "Sarah Kim",
    role: "Senior Inspector",
    experience: "11 years",
    speciality: "New Build Inspections",
  },
  {
    name: "Marcus Webb",
    role: "Inspector",
    experience: "7 years",
    speciality: "Pre-Purchase & Handover",
  },
];
...
export default function AboutPage() {
  return (
    <div style={{ background: "#FFFFFF" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2
                ...
                style={{ color: "#111827" }}
              >
                15 years. Hundreds of inspections. One standard.
              </h2>
              <div className="flex flex-col gap-4" style={{ color: "#6B7280" }}>
                <p className="text-base leading-relaxed">
                  Everestics started in Newcastle over 15 years ago with a team of licensed inspectors
                  and a belief that the industry needed more transparency. Too many buyers were settling
                  on properties with hidden problems. Too many builds were passing inspection with defects
                  that would cost thousands to fix later.
                </p>
                <p className="text-base leading-relaxed">
                  We set out to change that. Today we serve clients across Newcastle, the Hunter Valley,
                  and Sydney CBD — delivering the same rigorous, independent reports we started with,
                  backed by the most current Australian Standards and the National Construction Code.
                </p>
              </div>
            </motion.div>
      ...
      {/* Team */}
      <section className="py-24" style={{ background: "#F7F8FA", borderTop: "1px solid #E8EAED" }}>
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            className="text-center max-w-xl mx-auto mb-14"
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <p style={{ color: "#6B7280" }}>
              Every Everestics inspector is licenced, experienced, and personally committed to your outcome.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {team.map((member, i) => (
              <motion.div
                ...
                whileHover={{ borderColor: "rgba(249,115,22,0.3)", boxShadow: "0 6px 24px rgba(249,115,22,0.08)" }}
              >
                <div
                ...
                >
                  <div className="flex justify-between">
                    <span className="text-xs" style={{ color: "#9CA3AF" }}>Experience</span>
                    <span className="text-xs font-medium" style={{ color: "#374151" }}>{member.experience}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-xs" style={{ color: "#9CA3AF" }}>Speciality</span>
                    <span className="text-xs font-medium" style={{ color: "#374151" }}>{member.speciality}</span>
                  </div>
                </div>
              </motion.div>
            ))}
